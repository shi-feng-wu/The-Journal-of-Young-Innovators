        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-20 space-y-10">
          <div>
            ...
            <p className="text-sm md:text-md mb-8">
              The Brain-Targeted Teaching® (BTT) Model, created by Dr. Mariale
              Hardiman—former Vice Dean of the School of Education and current
              Professor Emeritus—bridges science and practice through a
              cohesive, six-step framework for effective instruction grounded in
              the latest research.
            </p>
            <p className="text-sm md:text-md mb-8">
              The Journal of Young Innovators is supported by the principles of
              Brain-Targeted Teaching, which foster creativity, critical
              thinking, and research-driven learning for the next generation of
              changemakers.
            </p>
            <a
          ...
          <div>
            ...
            <p className="text-sm md:text-md mb-8">
              ...
              knowledge, and connections they need to create a healthy economy,
              environment, and society in the Mid-Atlantic and globally.
            </p>
            <p className="text-sm md:text-md mb-8">
