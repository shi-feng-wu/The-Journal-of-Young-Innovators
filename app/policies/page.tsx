        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 md:gap-14 lg:gap-20">
          ...
          <PolicySection id="self-archiving" title="Author Self-Archiving">
            <p>
              ...
              (preprint), the <strong>accepted manuscript</strong> (postprint),
              and the <strong>published version</strong> (Version of Record) in
              any of the following venues, immediately upon publication and
              without seeking further permission:
            </p>
            <ul className="list-disc pl-6 space-y-1">
              <li>The author&apos;s personal or institutional website</li>
              <li>An institutional or subject repository (e.g., arXiv, SSRN)</li>
              <li>A scholarly social network (e.g., ResearchGate, Academia.edu)</li>
          ...
          <PolicySection id="data-availability" title="Data Availability">
            <p>
              ...
              are asked to deposit datasets in a public, recognized
              repository (e.g., Zenodo, OSF, Dryad, GitHub for code) and to
              cite the dataset in the manuscript with a persistent identifier
              where possible.
            </p>
            <p>
          ...
          <PolicySection id="complaints" title="Complaints and Appeals">
            <p>
              ...
              concerns or appeals about the editorial process or any
              published content. JYI follows{" "}
              <a
          ...
          <PolicySection id="archiving" title="Archiving and Preservation">
            ...
            <p>
              ...
              full content of the journal — including the article landing
              page and the article PDF — can be retrieved through{" "}
              <a
            ...
            <p>
              ...
              published under a CC BY 4.0 license with no embargo, authors
              are encouraged — and explicitly permitted — to deposit the
              published version in their institutional or subject repository
              for additional preservation redundancy. See the{" "}
          ...
          <PolicySection id="ownership" title="Ownership and Governance">
            <p>
              ...
              youth educational advancement and is not owned by, sponsored
              by, or operated for the financial benefit of any commercial
              entity.
            </p>
            <p>
          ...
          >
            <p>
              ...
              within published articles. The journal does not engage in
              direct marketing of acceptance, expedited review, or
              publication services to authors. Solicitations purporting to
              offer guaranteed acceptance, paid placement, or fee-based
              indexing should not be regarded as genuine communications from
              JYI and may be reported to{" "}
              <a href="mailto:editor@young-innovator.org">
                editor@young-innovator.org
              </a>
              .
