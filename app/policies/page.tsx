      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-20 pb-10 pt-10">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 md:gap-14 lg:gap-20">
          <div className="lg:col-span-3 max-w-[68ch]">
            ...
            <PolicySection id="ai" title="AI Use Policy">
              <p>
                The Journal of Young Innovators welcomes thoughtful use of AI
                tools. We also require honesty about it.
              </p>
              <h3 className="mt-2 font-text font-semibold text-black">
                What must be declared
              </h3>
              <p>
                If you used a large language model or any other generative AI
                tool (ChatGPT, Claude, Gemini, Copilot, and similar) at any
                stage of your research or writing, you must document that use in
                your manuscript. Include an &ldquo;AI Use Statement&rdquo; as a
                short section at the end of your paper, before the reference
                list. If AI shaped your methods, for example by coding data or
                generating analysis, describe it in the Methods section instead.
              </p>
              <p>
                Your statement should name the tool, the version if you know it,
                and what you actually used it for. One or two sentences is
                enough. For example:
              </p>
              <blockquote className="border-l-2 border-black/30 pl-4 italic">
                &ldquo;ChatGPT (GPT-4) was used to brainstorm interview
                questions during the design stage. All questions were revised by
                the author before use.&rdquo;
              </blockquote>
              <h3 className="mt-2 font-text font-semibold text-black">
                What does not need to be declared
              </h3>
              <p>
                Basic copyediting. If a tool only checked your spelling,
                grammar, or punctuation, no statement is needed.
              </p>
              <h3 className="mt-2 font-text font-semibold text-black">
                What is not permitted
              </h3>
              <p>
                AI tools cannot be listed as an author or co-author. Authors
                remain fully responsible for every claim in the manuscript. Text
                generated by AI and submitted as your own writing, fabricated
                data, and citations that do not correspond to real sources are
                grounds for rejection.
              </p>
              <p>
                Please verify that every reference in your paper exists and says
                what you claim it says. Generative tools invent
                plausible-looking citations, and this is one of the most common
                problems we see.
              </p>
              <p>
                Failing to declare AI use, or misrepresenting the extent of it,
                is also grounds for rejection.
              </p>
              <h3 className="mt-2 font-text font-semibold text-black">
                Screening and consequences
              </h3>
              <p>
                All submissions are screened using our institutionally approved
                AI detection systems. Any manuscript returning a result above
                20% AI-generated content will be rejected automatically, and no
                further submissions from that author will be considered.
              </p>
              <h3 className="mt-2 font-text font-semibold text-black">
                Check your own draft before you submit
              </h3>
              <p>
                Because this threshold applies to every submission, we strongly
                encourage you to run your draft through a detection tool
                yourself before sending it to us:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  ...
                  (grammarly.com) includes an AI detection feature alongside its
                  writing checks
                </li>
                <li>
                  <a
                    href="https://copyleaks.com/ai-detector"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Copyleaks AI Detector
                  </a>{" "}
                  (copyleaks.com/ai-detector)
                </li>
              </ul>
              <h3 className="mt-2 font-text font-semibold text-black">
                Further reading
              ...
              <p>
                We encourage you to read the guidance published by these
                organizations:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <a
                    href="https://www.springer.com/gp/editorial-policies/artificial-intelligence--ai-/25428500"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Springer
                ...
                <li>
                  <a
                    href="https://www.elsevier.com/about/policies-and-standards/the-use-of-generative-ai-and-ai-assisted-technologies-in-writing-for-elsevier"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Elsevier
                ...
                <li>
                  <a
                    href="https://poorvucenter.yale.edu/aiadvicestudents"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Yale Poorvu Center
                ...
                <li>
                  <a
                    href="https://ethics.berkeley.edu/privacy/appropriate-use-generative-ai-tools"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    UC Berkeley
