...
>) => (
  <Link
    href={href}
    className={`relative z-[1] inline-flex items-center whitespace-nowrap px-2 py-2 text-[13px] 2xl:px-3 2xl:text-sm text-white transition-colors rounded-md hover:text-white/90 ${className ?? ""}`}
    {...props}
  >
    {children}
  </Link>
